package com.yomahub.liteflow.test.ai.core.structure.cmp.ollama;
...
@AIComponent(
        nodeId = "OllamaStructureStream",
        nodeName = "OllamaStructureStream",
...
public interface OllamaStructureStreamCmp {
}
