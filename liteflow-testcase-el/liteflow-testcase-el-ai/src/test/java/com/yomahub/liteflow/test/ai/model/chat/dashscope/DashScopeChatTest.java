...
public class DashScopeChatTest extends MockAITest {
    ...
    public void testBlocking() {
        ...
        Assertions.assertTrue(response.getOutput().getContent().contains("黑洞"));
    }
    ...
    public void testStreaming() {
        ...
        Assertions.assertEquals(FinishReason.STOP, response.getFinishReason());
        Assertions.assertEquals(MessageType.ASSISTANT, response.getOutput().getMessageType());
        Assertions.assertTrue(response.getOutput().getContent().contains("宇宙"));
    }
